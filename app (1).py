...
with st.form("prediction_form"):
    ...
    submitted = st.form_submit_button("Predict Package 💼")

if submitted:
    if not name.strip():
        st.warning("Naam daal pehle, phir prediction chalega 🙂")
    else:
        ...
        st.markdown(
            f"""
            **Hello {name},**
            this is just a simple prediction — you can absolutely earn **more** than this.

            Stay hungry, stay sharp — your hustle isn't over yet. 🔥
            """
        )
